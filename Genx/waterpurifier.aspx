<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="waterpurifier.aspx.cs" Inherits="waterpurifier" %>
    ...
    <div>
        ...
        <header>
            <div id="bg-img11" class="bg-img">
                <p class="headspan">WATER PURIFIERS</p>
            </div>
            <style type="text/css">
                @media only screen and (max-width: 900px) {
                    #bg-img11 {
