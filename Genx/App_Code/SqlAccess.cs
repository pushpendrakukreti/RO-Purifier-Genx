...
namespace SqlAccess
{
    ...
    public class MySqlDataAccess
    {
        ...
        //Shared variable for holding connection String
		...
		******************************************************************/
        ...
        /// <remarks>
        /// e.g.:  
        ///  DataSet ds = ExecuteDataView(connectionString, CommandType.StoredProcedure, "GetOrders", new SqlParameter("@prodid", 24));
        /// </remarks>
        /// <param name="connectionString">a valid ConnectionString</param>
        /// <param name="commandType">the CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">the stored procedure name or T-SQL command</param>
        /// <param name="commandParameters">an array of SqlParamters used to execute the command</param>
        /// <returns>a dataview containing the resultset generated by the command</returns>
        public static DataView ExecuteDataView(string connectionString, CommandType commandType, string commandText, params  SqlParameter[] commandParameters)
        {
            DataSet dsResult;
            DataView dvResult;

            //pass through the call providing null for the set of SqlParameters
            dsResult = ExecuteDataset(connectionString, commandType, commandText, commandParameters);
