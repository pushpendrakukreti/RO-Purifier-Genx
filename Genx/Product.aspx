...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <header>
        <div id="bg-img11" class="">
            <p class="headspan">OUR PRODUCTS</p>
        </div>
        ...
        <section class="our-projects style-2 padd-5" style="background-image:url(images/background/bg8.png)">
            <div class="container">
                <div class="row">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="Select distinct a.ProductId, a.Name, a.Price, a.Description, a.Thumbnail, a.Image, v.SubCategoryId from t_Product a, t_ProductCategory v where a.Productid = v.Productid order by a.Name"></asp:SqlDataSource>
                </div>
                <%--<div class="row">
                    ...
                    <asp:Repeater ID="Repeater1" runat="server" DataSourceID="SqlDataSource2">
                        <ItemTemplate>
                            <li class="item col-md-4 col-sm-6 col-xs-12 fjs_item" data-position="1" data-price="20500" id="fjs_1" style="display: block;">
                                        ...
                                        <div class="product">
                                            <div class="product-head" style="margin-bottom:0px;">
                                                <h2><a href="description.aspx"><%# Eval("productname") %></a></h2>
                                                <p style="font-size: 15px; margin-top:8px;"><%# Eval("productdesc") %></p>
                                            </div>
                                            <div class="image image-product-responsive" style="background-color:azure; padding-top:6%; padding-top:6%; margin-bottom:10%;">
                                                <a href="description.aspx">
                                                    <asp:Image ID="Image2" runat="server" ImageUrl='<%# Eval("productimage","../Upload/{0}") %>' Height="200" Width="200"/>
                                            </div>
                                            <div class="review-tag" style="margin-left: 10px; font-size:14pt; color: #3C83F5; text-transform: uppercase; font-weight: bold;">
                                                <span class="price-tag buy-ro-price">MRP:  INR  <%# Eval("productprice") %>/- </span>
                                            </div>
                                            <div class="botBtn" style="margin-top:-1%;">
                                                <a href="description.aspx" class="prodBtn" rel="nofollow noopener">View Detail
                                                </a>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:GENX %>" SelectCommand="SELECT [productname], [productimage], [productprice], [productdesc], [pcategory] FROM [product1]"></asp:SqlDataSource>
                </div>--%>
            </div>
        </section>
</asp:Content>
